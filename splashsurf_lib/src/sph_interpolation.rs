...
/// Data associated with each particle that is stored in the R-tree for fast SPH neighbor queries
...
pub fn compute_sph_normals<R: Real>(
    ...
    // Collect all particle entities for the R-tree for fast SPH neighbor queries
    ...
    let normals = {
        ...
        interpolation_points
            ...
            .map(|x_i| {
                ...
                // Iterate over all other particles within the squared support radius
